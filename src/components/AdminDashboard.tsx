...
import { PairingControl } from './admin/PairingControl';
import { Analytics } from './admin/Analytics';
import { ExportData } from './admin/ExportData';
import type { User, Team, Designation, Pairing } from '../App';
...
type AdminSection = 'users' | 'masterdata' | 'pairing' | 'analytics' | 'export';
...
export function AdminDashboard({
  ...
  const menuItems = [
    ...
    { id: 'masterdata' as AdminSection, label: 'Master Data', icon: Building2 },
    { id: 'pairing' as AdminSection, label: 'Pairing Control', icon: Shuffle },
    { id: 'analytics' as AdminSection, label: 'Analytics', icon: BarChart3 },
    { id: 'export' as AdminSection, label: 'Export Data', icon: Download },
  ];
